// ============================================================================
// MFT 核心(从 light-c-main 移植)— USN 枚举 + $MFT 顺序读取(供 big_files 使用)
// ============================================================================
...
fn parse_file_record_metadata(record: &[u8]) -> Option<MftFileMetadata> {
    ...
    Some(MftFileMetadata {
        size,
        modified,
        is_cloud_placeholder: crate::storage_scan::big_files::has_cloud_placeholder_attributes(
            file_attributes,
        ),
    })
}
