// ============================================================================
// 扫描引擎(从 light-c-main 移植)
// 使用并行扫描优化性能,只扫描已知缓存/临时目录,不做全盘泛匹配
// ============================================================================
...
use super::{CategoryScanResult, FileInfo, JunkCategory, JunkScanResult};
...
impl ScanEngine {
    ...
    /// 执行完整扫描(并行扫描所有分类)
    pub fn scan(&self) -> JunkScanResult {
        ...
        // 汇总结果
        let mut result = JunkScanResult::new();
